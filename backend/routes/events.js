...
router.get('/sponsor/approved-events', auth, async (req, res) => {
...
router.post('/sponsor/select-package', auth, async (req, res) => {
  if (req.user.user_role !== 'sponsor') {
...
router.get('/sponsor/payments', auth, async (req, res) => {
  if (req.user.user_role !== 'sponsor') {
...
router.post('/sponsor/pay/:payment_id', auth, async (req, res) => {
  if (req.user.user_role !== 'sponsor') {
