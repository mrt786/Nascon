...
const HomePage = ({ roles }) => {
  ...
  return (
    <div className="bg-slate-800 text-white">
      ...
      <div className="w-screen h-screen bg-[url('/herosection.jpeg')] bg-cover bg-center bg-no-repeat py-16 px-6 md:px-20">
    </div>
      ...
      {/* University Section */}
      <div className="w-screen h-screen bg-[url('/fast.jpg')] bg-cover bg-center bg-no-repeat py-16 px-6 md:px-20">
</div>
