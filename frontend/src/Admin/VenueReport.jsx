...
const VenueUtilizationReport = () => {
    ...
    const fetchReport = async () => {
      try {
        ...
        const { data } = await axios.get(
          'http://localhost:3000/admin/reports/venue-utilization',
  ...
  // Dynamically derive table headers from the first row
...
export default VenueUtilizationReport;
