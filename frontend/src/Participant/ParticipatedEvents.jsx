...
const ParticipatedEvents = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 bg-slate-800">
      ...
      <motion.div
        key={event.event_id}
        className="group bg-slate-900 shadow-md rounded-lg p-6 hover:shadow-xl transition-all duration-500 border border-orange-500 text-white overflow-hidden"
